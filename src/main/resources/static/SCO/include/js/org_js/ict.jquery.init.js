...
function fc_applySystemEnv() {
	...
	if ( fc_isNull( fc_getSessionItem( 'GW_SYSTEM_ENV' ) ) ) {
		...
		window.gwMesEnv.format.slab.thk   = fc_isNull( sysEnv.UOM_SB_THK ) ? window.gwMesEnv.format.slab.thk   : sysEnv.UOM_SB_THK;
		window.gwMesEnv.format.slab.wth   = fc_isNull( sysEnv.UOM_SB_WTH ) ? window.gwMesEnv.format.slab.wth   : sysEnv.UOM_SB_WTH;
		window.gwMesEnv.format.slab.lth   = fc_isNull( sysEnv.UOM_SB_LTH ) ? window.gwMesEnv.format.slab.lth   : sysEnv.UOM_SB_LTH;
		window.gwMesEnv.format.slab.wgt   = fc_isNull( sysEnv.UOM_SB_WGT ) ? window.gwMesEnv.format.slab.wgt   : sysEnv.UOM_SB_WGT;
		window.gwMesEnv.format.plate.thk  = fc_isNull( sysEnv.UOM_PT_THK ) ? window.gwMesEnv.format.plate.thk  : sysEnv.UOM_PT_THK;
		window.gwMesEnv.format.plate.wth  = fc_isNull( sysEnv.UOM_PT_WTH ) ? window.gwMesEnv.format.plate.wth  : sysEnv.UOM_PT_WTH;
		window.gwMesEnv.format.plate.lth  = fc_isNull( sysEnv.UOM_PT_LTH ) ? window.gwMesEnv.format.plate.lth  : sysEnv.UOM_PT_LTH;
		window.gwMesEnv.format.plate.wgt  = fc_isNull( sysEnv.UOM_PT_WGT ) ? window.gwMesEnv.format.plate.wgt  : sysEnv.UOM_PT_WGT;
		window.gwMesEnv.format.coil.thk   = fc_isNull( sysEnv.UOM_CO_THK ) ? window.gwMesEnv.format.coil.thk   : sysEnv.UOM_CO_THK;
		window.gwMesEnv.format.coil.wth   = fc_isNull( sysEnv.UOM_CO_WTH ) ? window.gwMesEnv.format.coil.wth   : sysEnv.UOM_CO_WTH;
		window.gwMesEnv.format.coil.lth   = fc_isNull( sysEnv.UOM_CO_LTH ) ? window.gwMesEnv.format.coil.lth   : sysEnv.UOM_CO_LTH;
		window.gwMesEnv.format.coil.wgt   = fc_isNull( sysEnv.UOM_CO_WGT ) ? window.gwMesEnv.format.coil.wgt   : sysEnv.UOM_CO_WGT;
		window.gwMesEnv.format.bloom.thk  = fc_isNull( sysEnv.UOM_BL_THK ) ? window.gwMesEnv.format.bloom.thk  : sysEnv.UOM_BL_THK;
		window.gwMesEnv.format.bloom.wth  = fc_isNull( sysEnv.UOM_BL_WTH ) ? window.gwMesEnv.format.bloom.wth  : sysEnv.UOM_BL_WTH;
		window.gwMesEnv.format.bloom.lth  = fc_isNull( sysEnv.UOM_BL_LTH ) ? window.gwMesEnv.format.bloom.lth  : sysEnv.UOM_BL_LTH;
		window.gwMesEnv.format.bloom.wgt  = fc_isNull( sysEnv.UOM_BL_WGT ) ? window.gwMesEnv.format.bloom.wgt  : sysEnv.UOM_BL_WGT;
		window.gwMesEnv.format.billet.thk = fc_isNull( sysEnv.UOM_BI_THK ) ? window.gwMesEnv.format.billet.thk : sysEnv.UOM_BI_THK;
		window.gwMesEnv.format.billet.wth = fc_isNull( sysEnv.UOM_BI_WTH ) ? window.gwMesEnv.format.billet.wth : sysEnv.UOM_BI_WTH;
		window.gwMesEnv.format.billet.lth = fc_isNull( sysEnv.UOM_BI_LTH ) ? window.gwMesEnv.format.billet.lth : sysEnv.UOM_BI_LTH;
		window.gwMesEnv.format.billet.wgt = fc_isNull( sysEnv.UOM_BI_WGT ) ? window.gwMesEnv.format.billet.wgt : sysEnv.UOM_BI_WGT;
	...
	window.gwMesEnv.user.pgmTitle = fc_isNull( fc_getSessionItem( 'GW_TITLE' ) ) ? document.title : fc_getSessionItem( 'GW_TITLE' );
console.log('window.gwMesEnv.lang.isUseSession ======> ' + window.gwMesEnv.lang.isUseSession);
	window.gwMultiLang.isRunMain = window.gwMesEnv.lang.isUseSession;

	if ( fc_getDefPgmId() == 'main' ) {
		document.title = '[' + window.gwMesEnv.user.comNm + '] ' + 'MES';
	} else {
	...
	if ( window.gwMultiLang.isRunMain ) {
		console.log('fc_getSessionItem.GW_MULTILANG_ITEM ======> ' + fc_getSessionItem( 'GW_MULTILANG_ITEM' ));
...
function fc_applyAuthority() {
	...
	if ( !fc_isNull( window.gwJsonResult.RK_AUTH[ 0 ] ) ) {
		...
		var arrBtnNm = [ window.gwBtn.cust1Btn, window.gwBtn.cust2Btn, window.gwBtn.cust3Btn, window.gwBtn.cust4Btn, window.gwBtn.cust5Btn ];
		for ( var i=0;i<5;i++ ) {
...
function fc_includeTitle() {
	...
	try {
		...
		$( '#' + window.gwBtn.printBtn ).jqxButton({
			...
			imgSrc : "./include/images/icon_15.png",
			imgPosition  : "left",
			textPosition : "center",
			imgWidth  : 14,
			imgHeight : 13,
		...
		$( '#' + window.gwBtn.searchBtn ).jqxButton({
			...
			height : 25,
			theme  : window.gwMesEnv.themes,
			imgSrc : "./include/images/icon_12.png",
			imgPosition  : "left",
			textPosition : "center",
			imgWidth  : 14,
			imgHeight : 13,
		...
		$( '#' + window.gwBtn.saveBtn ).jqxButton({
			...
			height : 25,
			theme  : window.gwMesEnv.themes,
			imgSrc : "./include/images/icon_13.png",
			imgPosition  : "left",
			textPosition : "center",
			imgWidth  : 14,
			imgHeight : 13,
		...
		$( '#' + window.gwBtn.deleteBtn ).jqxButton({
			...
			height : 25,
			theme  : window.gwMesEnv.themes,
			imgSrc : "./include/images/icon_14.png",
			imgPosition  : "left",
			textPosition : "center",
			imgWidth  : 14,
			imgHeight : 13,
		...
		$( '#' + window.gwBtn.closeBtn ).jqxButton({
			...
			height : 25,
			theme  : window.gwMesEnv.themes,
			imgSrc : "./include/images/icon_18.png",
			imgPosition  : "left",
			textPosition : "center",
			imgWidth  : 14,
			imgHeight : 13,
...
//		fc_getMultiLangMessage();
		fc_setGridSetting();
		fc_setOpInfo();
		// set screen basic information ( authority, operation date/shift )
		if ( window.gwMesEnv.lang.isMultiLanguage )	fc_getMultiLanguage();
		fc_setColChooser();
			...
			if ( checktype ) {
				...
				if ( _type == 'GRID' ) {
					...
					if ( fc_checkDatatype( objData.object, 'lov' ) || fc_checkDatatype( objData.object, 'chklov' ) ) {
						fc_setFormDropdownListData( _targetObj[ 0 ], arrGridData, _listCount );
					} else {
