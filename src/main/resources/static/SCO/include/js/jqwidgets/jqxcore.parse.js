...
(function(a) {
    ...
    a.extend(a.jqx.mobile, {
        ...
        touchScroll: function(B, L, V, G, x, m) {
            if (B == null) {
                return
            }
            var F = this;
            ...
            var k, S, z, U, ac, O, W, c, E, Z, t, d, w, v, Q, b, D, ab, n;
            O = L;
            ac = 0;
            W = 0;
            xoffset = 0;
            U = x.jqxScrollBar("max");
            n = 325;

            function A(af) {
                if (af.targetTouches && (af.targetTouches.length >= 1)) {
                    return af.targetTouches[0].clientY
                } else {
                    if (af.originalEvent && af.originalEvent.clientY !== undefined) {
                        return af.originalEvent.clientY
                    } else {
                        var ae = F.getTouches(af);
                        return ae[0].clientY
                    }
                }
                return af.clientY
            ...
            function aa(af) {
                if (af.targetTouches && (af.targetTouches.length >= 1)) {
                    return af.targetTouches[0].clientX
                } else {
                    if (af.originalEvent && af.originalEvent.clientX !== undefined) {
                        return af.originalEvent.clientX
                    } else {
                        var ae = F.getTouches(af);
                        return ae[0].clientX
                    }
            ...
            var T = function(af) {
                ...
                if (a.inArray(af.target.tagName.toLowerCase(), P) !== -1) {
                    return
                }
                W = m.jqxScrollBar("value");
                xoffset = x.jqxScrollBar("value");
                var ag = F.getTouches(af);
                var ah = ag[0];
                if (ag.length == 1) {
                    F.dispatchMouseEvent("mousedown", ah, F.getRootNode(ah.target))
                }
            ...
            var Y = function(af, ae) {
                W = (af > O) ? O : (af < ac) ? ac : af;
                V(null, af, 0, 0, ae)
            };
            var l = function(af, ae) {
                xoffset = (af > U) ? U : (af < ac) ? ac : af;
                V(af, null, 0, 0, ae)
            };
            ...
            var y = function(ae) {
                ...
                var am = ah - s;
                I = af;
                touchHorizontalEnd = ah;
                f = al - e;
                h = am - g;
                j = true;
                e = al;
                g = am;
                var ag = x != null ? x[0].style.visibility != "hidden" : true;
                var ak = m != null ? m[0].style.visibility != "hidden" : true;
            ...
            var r = function(af) {
                ...
                F.scrolling[G] = false;
                if (j) {
                    F.dispatchMouseEvent("mouseup", ag, af.target)
                } else {
                    var ag = F.getTouches(af)[0],
                        ae = F.getRootNode(ag.target);
                    F.dispatchMouseEvent("mouseup", ag, ae);
                    F.dispatchMouseEvent("click", ag, ae);
                    return true
                }
            };
            if (this.simulatetouches) {
                ...
                var ad = a(document).on != undefined || a(document).bind;
                var J = function(ae) {
                    if (!F.scrolling[G]) {
                        return true
                    }
                    F.scrolling[G] = false;
                    var ag = F.getTouches(ae)[0],
                        af = F.getRootNode(ag.target);
                    F.dispatchMouseEvent("mouseup", ag, af);
                    F.dispatchMouseEvent("click", ag, af)
                };
                a(document).on != undefined ? a(document).on("touchend", J) : a(document).bind("touchend", J)
            }
            if (o.on) {
                o.on("dragstart", function(ae) {
                    ae.preventDefault()
                });
                o.on("selectstart", function(ae) {
                    ae.preventDefault()
                })
            }
