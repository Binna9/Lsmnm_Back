...
Modified by posco ict 2018.09.03
*/
(function(b) {
    ...
    b.extend(b.jqx._jqxGrid.prototype, {
            ...
            if (this.host.jqxMenu) {
                ...
                if (b.jqx.browser.msie && b.jqx.browser.version < 8 && this.filterable) {
                    ...
                    this.addHandler(b("#gridmenu" + this.element.id), "initialized", function() {
                        b("#menuWrappergridmenu" + s.element.id).css("z-index", 4980)
                    })
                }
                ...
                this.addHandler(this.gridmenu, "keydown", function(G) {
                    if (G.keyCode == 27) {
                        ...
                        if (G.keyCode == 13 && s.filterable) {
                            if (s._buildfilter) {
                                var F = b(b.find("#filter1" + s.element.id)).jqxDropDownList("container").css("display") == "block";
                                var E = b(b.find("#filter2" + s.element.id)).jqxDropDownList("container").css("display") == "block";
                                var C = b(b.find("#filter3" + s.element.id)).jqxDropDownList("container").css("display") == "block";
                                var H = b(b.find("#filterclearbutton" + s.element.id)).hasClass("jqx-fill-state-focus");
                                if (H) {
            ...
            b.each(this.columns.records, function(p, q) {
                if (!(this.hidden && this.hideable)) {
                    if (this.width.toString().indexOf("%") != -1 || this._percentagewidth != undefined) {
                        ...
                        if (n.scrollbarautoshow || n.scrollbarsize == 0) {
                            r = 0
                        }
                        var o = e;
        ...
        _renderwidgetcell: function(f, d, e, i, g) {
            ...
            if (h.find(".jqx-grid-widget").length == 0) {
                ...
                d.innerHTML = j;
                e.createwidget(i, e, g, d.firstChild);
                ...
                e.initwidget(f.getboundindex(i), e, g, d.firstChild);
                d.widgetrow = f.getboundindex(i);
            ...
            if (C.prerenderrequired == true) {
                ...
                for (var z = 0; z < u; z++) {
                    ...
                    for (var w = 0; w < A; w++) {
                        ...
                        d += '" class="' + l + '">';
                        var y = this._defaultcellsrenderer("", x);
                        d += y;
                        d += "</div>";
                        s += d
                    }
